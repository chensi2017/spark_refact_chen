...
class CheckPointT extends Assert{
  def main(args: Array[String]): Unit = {
    ...
    println(rddP)*/
    val sconf = new SparkConf().set("spark.serializer", "org.apache.spark.serializer.KryoSerializer").setAppName("socket").registerKryoClasses(Array(classOf[DPListWithDN],classOf[Array[DPUnion]],
